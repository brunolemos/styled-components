...
- Fixed prop changes not updating style on react native; thanks [@brunolemos](https://github.com/brunolemos). (see [#311](https://github.com/styled-components/styled-components/pull/311))
